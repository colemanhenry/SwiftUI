...
//  DesignCodeSwiftUI2
//
//  Created by H Coleman on 21/01/2020.
...
struct BottomCardView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Text("This certificate is proof that Henry Coleman has achieved the UI Design course with approval from a Design+Code instructor.")
