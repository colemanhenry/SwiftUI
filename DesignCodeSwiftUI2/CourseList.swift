...
//  DesignCodeSwiftUI2
//
//  Created by H Coleman on 04/02/2020.
    ...
    var body: some View {
        ZStack(alignment: .top) {
            VStack(alignment: .leading, spacing: 30.0) {
                Text(" Take your SwiftUI app to the App Store with Advanced techniques like API dats, packages & CMS.")
            ...
            VStack {
                ...
                Image(uiImage: course.image)
                    ...
                    .frame(maxWidth: 140, alignment: .top)
